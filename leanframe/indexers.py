...
class LocSeriesIndexer:
    def __init__(self, series: leanframe.series.Series):
        self._series = series

    def __setitem__(self, key, value) -> None:
        index = self._series.index
        # TODO(swast): support MultiIndex
        if not isinstance(index, leanframe.core.indexes.index.Index):
...
class IlocSeriesIndexer:
    ...
    def __getitem__(self, key) -> leanframe.scalar.Scalar | leanframe.series.Series:
        if isinstance(key, slice):
...
class _iLocIndexer:
    def __init__(self, dataframe: leanframe.DataFrame):
        self._dataframe = dataframe

    def __getitem__(self, key) -> leanframe.scalar.Scalar | leanframe.DataFrame:
        """
...
def _slice_block(
    block: leanframe.core.blocks.Block,
    start: typing.Optional[int] = None,
    stop: typing.Optional[int] = None,
    step: typing.Optional[int] = None,
) -> leanframe.core.blocks.Block:
...
def _slice_series(
    series: leanframe.Series,
    start: typing.Optional[int] = None,
    stop: typing.Optional[int] = None,
    step: typing.Optional[int] = None,
) -> leanframe.Series:
    return leanframe.Series(
