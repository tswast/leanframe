...
import leanframe.core.joins.row_identity
import leanframe.core.ordering
...
def join_by_column(
    ...
    *,
    ...
    if (
        how in leanframe.core.joins.row_identity.SUPPORTED_ROW_IDENTITY_HOW
        ...
        combined_expr, (
            get_column_left,
            get_column_right,
        ) = leanframe.core.joins.row_identity.join_by_row_identity(left, right, how=how)
        ...
        left_ordering_encoding_size = (
            ...
            or leanframe.core.ordering.DEFAULT_ORDERING_ID_LENGTH
        )
    ...
    join_key_col = (
        ...
        .name(leanframe.guid.generate_guid(prefix="index_"))
    )
...
def _merge_order_ids(
    ...
    return (
        (
            leanframe.core.ordering.stringify_order_id(left_id, left_encoding_size)
            + leanframe.core.ordering.stringify_order_id(right_id, right_encoding_size)
        )
    ).name(leanframe.guid.generate_guid(prefix="leanframe_ordering_id_"))
