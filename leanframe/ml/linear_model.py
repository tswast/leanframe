...
class LinearRegression(leanframe.ml.api_primitives.BaseEstimator):
    ...
    @staticmethod
    def _from_bq(session: leanframe.Session, model: bigquery.Model) -> LinearRegression:
        ...
        new_linear_regression._bqml_model = leanframe.ml.core.BqmlModel(session, model)
