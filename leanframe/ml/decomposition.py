...
class PCA(leanframe.ml.api_primitives.BaseEstimator):
    ...
    @staticmethod
    def _from_bq(session: leanframe.Session, model: bigquery.Model) -> PCA:
        ...
        new_pca = PCA(**kwargs)
        new_pca._bqml_model = leanframe.ml.core.BqmlModel(session, model)
        return new_pca
