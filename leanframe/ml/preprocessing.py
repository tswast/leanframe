...
class NoModelStandardScaler(leanframe.ml.api_primitives.BaseEstimator):
    ...
    def fit(self, X: leanframe.DataFrame):
    ...
    def transform(self, X: leanframe.DataFrame):
        """Transform X
        ...
        X = typing.cast(leanframe.DataFrame, X[self._avg.index.tolist()])
...
class StandardScaler(leanframe.ml.api_primitives.BaseEstimator):
    ...
    def _compile_to_sql(self, columns: List[str]) -> List[Tuple[str, str]]:
        ...
        return [
            (
                leanframe.ml.sql.ml_standard_scaler(column, f"scaled_{column}"),
                f"scaled_{column}",
            )
...
class OneHotEncoder(leanframe.ml.api_primitives.BaseEstimator):
    ...
    def _compile_to_sql(self, columns: List[str]) -> List[Tuple[str, str]]:
        ...
        return [
            (
                leanframe.ml.sql.ml_one_hot_encoder(column, f"onehotencoded_{column}"),
