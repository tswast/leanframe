...
name = "leanframe"
description = (
    "LeanFrame -- scalable analytics and machine learning with BigQuery"
)
...
with open(os.path.join(package_root, "leanframe/version.py")) as fp:
    exec(fp.read(), version)
version_id = version["__version__"]

# Only include packages under the 'leanframe' and 'leanframe_vendored' namespaces.
# Do not include tests, benchmarks, etc.
packages = [
    package
    for package in setuptools.find_namespace_packages()
    if package.startswith("leanframe")
]
...
setuptools.setup(
    ...
    author="LeanFrame authors",
    author_email="tswast@gmail.com",
    license="Apache 2.0",
    url="https://github.com/tswast/leanframe",
    classifiers=[
        release_status,
